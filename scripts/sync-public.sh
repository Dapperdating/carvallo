...
cp index.html auto.html selected.html admin.html privacy.html termini.html cookie.html styles.css script.js admin.js config.js favicon.png robots.txt sitemap.xml public/
